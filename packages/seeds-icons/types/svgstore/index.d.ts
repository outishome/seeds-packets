declare module 'svgstore' {
    type Options = {
        ...
        /**
         * A map of attributes to set on the root <svg> element. If you set an attribute's value to null,
         * you remove that attribute. Values may be functions like jQuery.
         *
         * @default false
         */
        ...
        /**
         * Attributes to have svgstore attempt to copy to the newly created `<symbol>` tag from it's
         * source `<svg>` tag. The `viewBox`, `aria-labelledby`, and role attributes are always copied.
         *
         * @default false
         */
        copyAttrs?: boolean | string[];
        /**
         * Rename defs content ids to make them inherit file names so that it would help to avoid
         * defs with same ids in the output file.
         *
         * @default false
         */
        renameDefs?: boolean;
